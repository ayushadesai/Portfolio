        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-[#18160F]/80">
              Fourth-year Data Science &amp; Business Administration student at
              Northeastern University. I build data pipelines, ML models, and
              web applications — with recent co-ops at Arrowstreet Capital and
              Scotiabank focused on operational risk and data operations.
            </p>
          </div>
          ...
          <div className="relative space-y-4">
            ...
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 px-5 py-4">
              <div className="flex items-center gap-2.5 text-sm font-semibold text-[#18160F]">
                <span className="inline-block h-2.5 w-2.5 rounded-full bg-emerald-500 shadow-[0_0_0_4px_rgba(16,185,129,0.18)] animate-pulse" />
                Available June 2026
              </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <article className="rounded-[1.75rem] border border-[#18160F]/8 bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 text-base leading-7 text-[#18160F]/70">
              Built risk monitoring tools and automated reporting pipelines for
          ...
          <article className="rounded-[1.75rem] border border-[#18160F]/8 bg-white p-8 shadow-sm">
            ...
            <p className="mt-3 text-base leading-7 text-[#18160F]/70">
              Supported data operations and internal analytics workflows across
