  ...
  return (
    <div className="mx-auto max-w-4xl px-6 pb-24 pt-14 lg:px-8">
      ...
      <section className="pb-16 border-b border-[#e8e8e8]">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a
            ...
            className="font-inter inline-flex items-center gap-2 rounded-full bg-[#1E3A5F] px-6 py-3 text-sm font-medium text-white shadow-sm transition hover:bg-[#152D48]"
          >
            Download Resume
          </a>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-inter inline-flex items-center gap-2 rounded-full border border-[#e0e0e0] bg-white px-6 py-3 text-sm font-medium text-[#1a1a1a] shadow-sm transition hover:bg-[#f4f4f2]"
          >
            LinkedIn
          </a>
        </div>
      ...
      <section className="mt-16 pb-16 border-b border-[#e8e8e8]">
        <p className="font-inter max-w-[560px] text-base text-[#444444]">
      ...
      <section className="mt-16">
        <p className="font-inter text-xs uppercase tracking-[0.35em] text-[#999999] mb-8">Skills</p>
        <div className="divide-y divide-[#ebebeb] rounded-xl border border-[#e8e8e8] bg-white overflow-hidden shadow-sm">
          {[
            ...
            >
              <span className="font-inter text-xs font-semibold uppercase tracking-[0.2em] text-[#999999]">
                {row.label}
              </span>
      ...
      <section className="mt-16 border-t border-[#e8e8e8] pt-16">
        <p className="font-inter text-xs uppercase tracking-[0.35em] text-[#999999] mb-8">About</p>
        <div className="font-inter max-w-[560px] space-y-4 text-base text-[#444444]">
          <p>
      ...
      <section className="mt-16 border-t border-[#e8e8e8] pt-16 pb-4">
        <p className="font-inter text-xs uppercase tracking-[0.35em] text-[#999999] mb-6">Education</p>
